...
class __TwigTemplate_c4c59e1114524bb3c6babe6d2f486268 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/charity_zymphonies_theme/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\portfoliodrupal\\themes\\contrib\\charity_zymphonies_theme\\templates\\content-edit\\filter-tips.html.twig");
    }
