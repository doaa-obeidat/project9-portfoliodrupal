...
/* themes/contrib/bond/templates/node/node.html.twig */
class __TwigTemplate_52ef2af49eb39875e0654da1cb6f97c6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<article";
  ...
  <div";
     ...
     ";
        // line 99
        if ((($context["node_has_image"] ?? null) && ((twig_get_attribute($this->env, $this->source, ($context["bond"] ?? null), "page_header_style", [], "any", false, false, true, 99) == "full-size") || (twig_get_attribute($this->env, $this->source, ($context["bond"] ?? null), "page_header_style", [], "any", false, false, true, 99) == "box-size")))) {
            // line 100
            echo "      ";
...
";
    ...
    {
        return "themes/contrib/bond/templates/node/node.html.twig";
    }
    ...
    {
        return new Source("", "themes/contrib/bond/templates/node/node.html.twig", "C:\\xampp\\htdocs\\portfoliodrupal\\themes\\contrib\\bond\\templates\\node\\node.html.twig");
    }
